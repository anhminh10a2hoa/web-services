/**
 * CustomerSpringServiceLocator.java
 *
...
public class CustomerSpringServiceLocator extends org.apache.axis.client.Service implements ws.customer.service.CustomerSpringService {

    public CustomerSpringServiceLocator() {
    }


    public CustomerSpringServiceLocator(org.apache.axis.EngineConfiguration config) {
        super(config);
    }

    public CustomerSpringServiceLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }

    // Use to get a proxy class for CustomerSpringServiceHttpSoap11Endpoint
    private java.lang.String CustomerSpringServiceHttpSoap11Endpoint_address = "http://localhost:8080/axis2/services/CustomerSpringService.CustomerSpringServiceHttpSoap11Endpoint/";
    ...
    public ws.customer.service.CustomerSpringServicePortType getCustomerSpringServiceHttpSoap11Endpoint() throws javax.xml.rpc.ServiceException {
    ...
    public ws.customer.service.CustomerSpringServicePortType getCustomerSpringServiceHttpSoap11Endpoint(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (ws.customer.service.CustomerSpringServicePortType.class.isAssignableFrom(serviceEndpointInterface)) {
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.customer.ws", "CustomerSpringService");
    }
